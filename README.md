...
5. Network topology: The physical layout of a networks, including the placement of switches, routers, and other network devices, can impact network performance.
